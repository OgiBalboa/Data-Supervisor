...
#-------------------------------PEAK BULMA-------------------------------------------------------     
    ...
    def peak1(self,):
        ...
        if self.reftime1 < settings.wait_for_next_peak: # 1 SANİYE BOYUNCA PEAK ALGILAMA
            return None
...
#yeni = analiz(yenisorgu.dosya,yenisorgu.dosya_yolu)
